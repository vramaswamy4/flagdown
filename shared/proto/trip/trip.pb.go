...
type Trip struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SelectFare    *RideFare              `protobuf:"bytes,2,opt,name=selectFare,proto3" json:"selectFare,omitempty"`
...
func (x *Trip) GetSelectFare() *RideFare {
	if x != nil {
		return x.SelectFare
	}
	return nil
...
// static drier object that is used to store the driver info
...
const file_trip_proto_rawDesc = "" +
	...
	".trip.TripR\x04trip\"\xc3\x01\n" +
	"\x04Trip\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12.\n" +
	"\n" +
	"selectFare\x18\x02 \x01(\v2\x0e.trip.RideFareR\n" +
	"selectFare\x12!\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	5,  // 7: trip.Trip.selectFare:type_name -> trip.RideFare
